          ...
          <div className="@container/main flex flex-1 flex-col gap-2">
            <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6 px-4 lg:px-6">
              <div>
                ...
                <p className="text-muted-foreground">Your medical history and treatment records</p>
              </div>
              ...
              <Card>
                ...
                <CardContent className="grid gap-4 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <p className="text-base">{userDetails?.phone || "Not provided"}</p>
                  </div>
                  <div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Important medical information for your dentist</CardDescription>
                </CardHeader>
                <CardContent>
                  {userDetails?.medicalHistory ? (
                    <p className="text-base whitespace-pre-wrap">{userDetails.medicalHistory}</p>
                  ) : (
              ...
              <Card>
                ...
                <CardContent>
                  {!userDetails?.appointmentsAsPatient || userDetails.appointmentsAsPatient.length === 0 ? (
                    <p className="text-muted-foreground text-center py-8">No treatment history</p>
                  ) : (
